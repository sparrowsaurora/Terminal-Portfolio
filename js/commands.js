...
I've just completed my Diploma of Information Technology (Advanced Programming) at North Metropolitan TAFE 
and I'm currently studying Programming doing my bachelor's degree at Curtin University.
...
- Realtime Chat app - A TCP based terminal chatroom
- Nocturne - A TUI music app
etc. (Type <span class="highlight">'projects'</span> to see more)

I primarily use C++ and C when building my projects.
...
// It also has user customisations, like colours for a specific user's messages for clarity.`,
    ...
    nocturne: `A local TUI music app made because I am sick of spotify restricting the songs I can play.
An configurable terminal-based app that interfaces with local audio files to play and control music (or other audio files).
It was made to accompany an Embedded systems project which functions as a physical controller for this app.`,
